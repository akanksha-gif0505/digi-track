  ...
  return (
    <header className="w-full top-0 sticky bg-white shadow-sm z-30 border-b border-[#eff4ff]">
      <div className="flex justify-between items-center px-4 py-2.5 w-full max-w-5xl mx-auto">
        ...
        >
          <div className="w-9 h-9 rounded-full bg-[#005c55]/10 flex items-center justify-center text-[#005c55] group-hover:bg-[#005c55]/15 transition-colors">
            <span className="material-symbols-outlined fill-1 text-[22px] text-[#005c55]">
              account_balance_wallet
            </span>
          </div>
          <div className="flex flex-col">
            <h1 className="font-display text-[20px] leading-[26px] font-bold text-[#005c55] tracking-tight">
              Digi Track
            </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-[#eff4ff] hover:bg-[#e5eeff] text-[#005c55] transition-all relative border border-[#bdc9c6]/40"
          >
            <span
          ...
          {userProfile.isAuthenticated ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="w-9 h-9 rounded-full overflow-hidden border-2 border-[#bdc9c6] hover:border-[#005c55] transition-colors focus:outline-none focus:ring-2 focus:ring-[#005c55]/30 flex items-center justify-center"
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-[#bdc9c6]/40 p-2 z-50 animate-in fade-in zoom-in-95">
                  <div className="p-2.5 border-b border-[#eff4ff] flex items-center gap-2.5">
                    <img
                      src={userProfile.avatarUrl}
                      alt={userProfile.name}
                      className="w-9 h-9 rounded-full object-cover border border-[#bdc9c6]"
                      referrerPolicy="no-referrer"
                    />
